...
Зачем: «исчезло из наших первых страниц листинга» ≠ «снято с сайта» —
...
Запуск: python -m kz.collect.check_status   (раз в день, после parser.py)
"""
...
MAX_CHECKS_PER_RUN = 20     # мелкая порция (анти-бан; было 150 → домашний IP словил блок)
DELAY_RANGE        = (4.0, 8.0)
