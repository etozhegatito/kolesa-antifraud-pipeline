...
<div class="card">
  ...
  <p class="muted">Карточки подозрительных объявлений: фото, текст, флаги.
  Вердикт сохраняется в журнал сразу.</p>
</div>
<div class="card">
  <h2 style="margin-top:0"><a href="/damage">Разметка повреждений →</a></h2>
  <p class="muted">Обвести повреждение рамкой на фотографии. Нужно для
  дешёвого сегмента: там цену определяет состояние, которого нет в
  характеристиках объявления.</p>
</div>
