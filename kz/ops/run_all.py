...
ML_CHAIN = [
    ...
    # Мониторинг после обучения, а не до: сравнивать надо с ТОЙ выборкой, на
    # которой училась текущая модель. Дёшево (секунды) и копит историю, по
    # которой видно тренд — одиночный замер не отличит колебание от дрейфа.
    step("ML 6 · дрейф данных",      "kz.ml.monitoring"),
    step("ML 7 · срок жизни объявления", "kz.ml.survival"),
]
