...
ценой, combined — 0,635. В продукт CV не включён — см. FINDINGS §19-24.
При редком positive-классе рядом считается PR-AUC: 0,392 у CLIP-vector
против 0,519 у age+price. Фото-CV группирует не только кадры одного `ad_id`,
