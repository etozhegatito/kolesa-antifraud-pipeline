...
| размечено кадров фотографий | 782; 38 из 47 damaged-кадров ждут перепроверки definition drift |
...
отозваны: аудит definition drift отправил 38 из 47 `damaged`-кадров на
