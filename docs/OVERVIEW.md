...
> нашёл definition drift, и 38 из 47 кадров требуют визуальной перепроверки.
...
definition drift: 38 из 47 `damaged`-кадров требуют визуальной
перепроверки. Все кадры одного объявления по-прежнему обязаны лежать в одном
