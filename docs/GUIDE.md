...
**Цель: MAPE 18%.** Сейчас routed MAPE 21,16%; одна общая модель даёт
21,41%.
...
|---|---|
| 28,6% (сейчас, со специалистом) | 21,16% |
| 26% | 20,1% |
| 24% | 19,3% |
| **20,8%** | **18,0%** |
...
Настоящий блокер — дешёвый сегмент: 40% выборки, routed MAPE 28,6%, и там цену
...
модель цены       routed MAPE 21,16% | median APE 13,90% | R²(log) 0,936
                  OOT MAPE 21,99%
                  одна общая модель 21,41%; baseline 29,96%
                  выигрыш routed над baseline 8,8 п.п.
                  baseline почти догнал base по медиане: 14,30% против 14,19%
                  routed-медиана лучше: 13,90%
сегменты          <5М 28,6%   5-10М 15,3%   10-20М 15,5%   20М+ 17,9%
...
блокер №1         дешёвый сегмент: 40% выборки, MAPE 28,6%, и вся
