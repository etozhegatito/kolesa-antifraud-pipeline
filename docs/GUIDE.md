...
```
данные            4365 объявлений, 1156 обогащено (27%)
подозрительных    31 (0.7%)
вердиктов         29, из них fraud — 0

модель цены       MAPE 23.0%  |  медиана 14.5%  |  R²(log) 0.917
                  out-of-time MAPE 20.5%
                  baseline 39.1% → выигрыш 16.2 п.п.
сегменты          <5М 31.4%   5-10М 17.4%   10-20М 17.2%   20М+ 20.2%

цель              MAPE 15%
план              −4 п.п. ограничить возраст, −2.7 п.п. удвоить данные,
                  остальное — сигнал о состоянии из фотографий

блокер №1         разметка: нужны вердикты по контрольной группе
```
