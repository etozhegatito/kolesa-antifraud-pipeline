...
проверен через grouped OOF и пока не прошёл gate: AUC 0,658 против 0,739 у
возраста с ценой. Поэтому целевая мультимодальная архитектура остаётся планом,
а не выданной за готовую частью продукта:
