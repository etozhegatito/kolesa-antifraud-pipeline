...
# ОБЩИЙ для всех kolesa-джобов (один IP!); у CDN — свой. Консервативно.
# 400 kolesa = ровно по одной порции каждого из трёх джобов в день
# (150+120+120≈390): 300 голодал бы третий джоб (два первых съедали бы
# общий бюджет). Хочешь быстрее/медленнее — крути эти два числа.
DAILY_BUDGET = {"kolesa": 400, "cdn": 1200}
