...
антифрод    185 подозрительных (1,5%), 111 вердиктов
...
код         11 500+ строк, 248 офлайн-тестов + 6 с test-БД, CI на GitHub Actions
```
...
python -m pytest tests/ -q    # 248 passed, 6 skipped без test-БД
```
